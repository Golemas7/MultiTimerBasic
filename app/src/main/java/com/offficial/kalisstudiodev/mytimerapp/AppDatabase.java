...
class AppDatabase extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "MyTimerApp.db";
...
//        sSQL = "CREATE TABLE Tasks (_id INTEGER PRIMARY KEY NOT NULL, Name TEXT NOT NULL, Description TEXT, SortOrder INTEGER, CategoryID INTEGER);";
        sSQL = "CREATE TABLE " + TasksContract.TABLE_NAME + " ("
                ...
                + TasksContract.Columns.TASKS_TIME + " INTEGER, "
                + TasksContract.Columns.TASKS_CURRENT_TIME + " INTEGER, "
                + TasksContract.Columns.TASK_IS_PLAYING + " TEXT);";
